...
// Define where the E2E tests are located (relative to this config file)
const testDir = path.resolve(__dirname, 'e2e'); // Or simply 'e2e'
...
export default defineConfig({
  ...
  webServer: {
    command: 'npm run dev', // Changed: Run dev server from frontend directory
